package com.ginvar.library.mediarecord.utils;
...
//                stream.mSampleRate, stream.mChannels);
//        format.setInteger(MediaFormat.KEY_AAC_PROFILE, stream.mProfile);
//        format.setInteger(MediaFormat.KEY_BIT_RATE, (int) stream.mBitrate);
//        format.setInteger("channel-layout", (int) stream.mChannelLayout);
//        format.setInteger("sample-fmt", stream.mFormat);
//        format.setInteger("samples", stream.mFrameSize);
//        format.setInteger(MediaFormat.KEY_CHANNEL_COUNT, stream.mChannels);
//
//        ByteBuffer buffer = ByteBuffer.allocateDirect(stream.mCodecSpecDescription.remaining());
//        buffer.put(stream.mCodecSpecDescription);
//        buffer.flip();
...
//                if (mediaInfo.audioCodecName != null && mediaInfo.audioCodecName.contains(codecName)) {
//                    return true;
//                }
//            }
//        }
