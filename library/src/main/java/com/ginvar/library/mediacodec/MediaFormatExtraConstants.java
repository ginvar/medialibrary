...
public class MediaFormatExtraConstants {
    ...
    // from https://android.googlesource.com/platform/frameworks/av/+/lollipop-release/media/libstagefright/
    // ACodec.cpp#2623
    /**
    ...
    // MediaCodec.cpp#2197
    /**
     * Included in MediaFormat from
     * {@link android.media.MediaExtractor#getTrackFormat(int)}. Value is {@link java.nio.ByteBuffer}.
     */
