...
//            YYLog.info(this, Constant.MEDIACODE_ENCODER + "encoded bitRate:" + mBitRate + ", mFrameCnt:" + mFrameRate +
//                    " input_video_size=" + mInputByteSize + " output_video_size=" + mOutputByteSize);
...
//        Log.i(this, Constant.MEDIACODE_ENCODER + "setEncodeCfg " + cfg.toString());
    ...
    public boolean checkEncodeUpdate(int width, int height, boolean bLowDelay, int frameRate, int bitRate,
                                     String encodeParameter) {
        boolean ret = false;
        if (mEncoderConfig.getEncodeHeight() != height || mEncoderConfig.getEncodeWidth() != width) {
//            Log.i(this,
//                    Constant.MEDIACODE_ENCODER + "checkEncodeUpdate from " + mEncoderConfig.getEncodeHeight() + "x" +
...
//            YYLog.info(this,
//                    Constant.MEDIACODE_ENCODER + "checkEncodeUpdate lowDelay from " + mEncoderConfig.mLowDelay +
//                            ", to " + bLowDelay);
...
//            YYLog.info(this,
//                    Constant.MEDIACODE_ENCODER + "checkEncodeUpdate frameRate from " + mEncoderConfig.mFrameRate +
//                            ", to " + frameRate);
        ...
        if (mEncoderConfig.mBitRate != bitRate) {
            YYLog.info(this, Constant.MEDIACODE_ENCODER + "checkEncodeUpdate biteRate from " +
            mEncoderConfig.mBitRate + ", to " + bitRate);
        ...
        */
        ...
        if ((!mEncoderConfig.mLowDelay || mEncoderConfig.mEncodeType != VideoEncoderType.SOFT_ENCODER_X264)
                && mEncoderConfig != null
                && ((mEncoderConfig.mEncodeParameter == null && encodeParameter != null) ||
                (mEncoderConfig.mEncodeParameter != null &&
                        !mEncoderConfig.mEncodeParameter.equals(encodeParameter)))) {
//            YYLog.info(this,
//                    Constant.MEDIACODE_ENCODER + "checkEncodeUpdate param from " + mEncoderConfig.mEncodeParameter +
//                            ", to " + encodeParameter);
